  ...
  const techIcons = [
    {
      src: pythonLogo,
      alt: 'Python',
      description: 'Python aplicado a ciencia de datos'
    },
    {
      src: nodejsLogo,
      alt: 'NodeJS',
      description: 'Flujos de carga de datos y APIs desarrollados en NodeJS'
    },
    {
      src: postgresLogo,
      alt: 'PostgreSQL',
      description: 'Servicios PostgreSQL para bases de datos relacionales'
    },
    {
      src: mongodbLogo,
      alt: 'MongoDB',
      description: 'Servicios MongoDB para colecciones de datos flexibles'
    },
    {
      src: reactlogo,
      alt: 'React',
    ...
    },
    {
      src: dockerLogo,
      alt: 'Docker',
      description: 'Despliegue de microservicios mediante Docker'
    }
  ]
  const toolIcons = [
    {
      src: excelLogo,
      alt: 'Excel',
      description: 'Reportes para interactuar con los análisis'
    },
    {
      src: powerbiLogo,
      alt: 'PowerBI',
      description: 'Dashboards para el área de negocio'
    },
    {
      src: tableauLogo,
      alt: 'Tableau',
      description: 'Tableau para Business Insights avanzados'
    },
    {
      src: pandasLogo,
      alt: 'Pandas',
      description: 'Herramientas a medida para analizar los datos'
    },
    {
      src: matplotlibLogo,
      alt: 'Matplotlib',
    ...
    },
    {
      src: tensorflowLogo,
      alt: 'TensorFlow',
      description: 'Modelos de Machine Learning e IA'
    }
  ]
  return (
    <section className='aboutContainer' id='about'>
      ...
      <div className='aboutContent'>
        ...
        <p className='aboutDescription'>
          ...
          decisiones inteligentes. Diseñamos estrategias únicas, combinando
          experiencia, tecnología avanzada y una comunicación cercana para
        ...
        <p className='aboutDescription'>
          Seleccionamos cuidadosamente las herramientas y tecnologías que nos
          permiten ofrecer soluciones innovadoras, confiables y escalables.
          Desde lenguajes de programación robustos hasta plataformas avanzadas
          de almacenamiento y procesamiento, nuestra meta es garantizar
